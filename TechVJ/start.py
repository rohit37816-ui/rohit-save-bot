...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("鉂ｏ笍 Developer", url = "https://t.me/kingvj01")
    ],[
        InlineKeyboardButton('馃攳 s岽溼礃岽樶磸蕗岽� 散蕗岽忈礈岽�', url='https://t.me/vj_bot_disscussion'),
        InlineKeyboardButton('馃 岽溼礃岽呩磤岽涐磭 岽勈溼磤纱纱岽囀�', url='https://t.me/vj_botz')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await client.send_message(
        chat_id=message.chat.id, 
        text=f"<b>馃憢 Hi {message.from_user.mention}, I am Save Restricted Content Bot, I can send you restricted content by its post link.\n\nFor downloading restricted content /login first.\n\nKnow how to use bot by - /help</b>", 
